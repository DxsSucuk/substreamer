 ...
 * palette: a 2-stop gradient from the extracted primary (the dominant/vibrant
 * cover colour, lightness-clamped) to `endColor`. Returns the raw
 * `gradientOpacity` shared value so each player surface animates it its own way
