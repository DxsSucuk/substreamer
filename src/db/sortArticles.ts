 ...
 * keys) creates a require cycle, because `serverInfoStore` itself persists through the
 * persistence layer. This module imports nothing, so it can't participate in a cycle.
 *
